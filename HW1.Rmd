...
(var(x))
```
#####*It is normal to get values different from waht expected as n is not big enough. As n grows we will get values close to the predicted ones.As we can see by changing the n = 100000 below*
